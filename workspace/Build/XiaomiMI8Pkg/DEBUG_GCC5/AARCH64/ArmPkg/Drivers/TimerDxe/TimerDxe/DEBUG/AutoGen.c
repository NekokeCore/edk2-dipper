...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdArmArchTimerSecIntrNum = _PCD_VALUE_PcdArmArchTimerSecIntrNum;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdArmArchTimerIntrNum = _PCD_VALUE_PcdArmArchTimerIntrNum;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdArmArchTimerVirtIntrNum = _PCD_VALUE_PcdArmArchTimerVirtIntrNum;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdArmArchTimerHypIntrNum = _PCD_VALUE_PcdArmArchTimerHypIntrNum;
