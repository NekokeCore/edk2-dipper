...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9588502a, 0x5370, 0x11e3, {0x86, 0x31, 0xd7, 0xc5, 0x95, 0x13, 0x64, 0xc8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AndroidFastbootApp";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAndroidFastbootPlatformProtocolGuid = { 0x524685a0, 0x89a0, 0x11e3, {0x9d, 0x4d, 0xbf, 0xa9, 0xf6, 0xa4, 0x03, 0x08}};
...
{
  return FastbootAppEntryPoint (ImageHandle, SystemTable);
}
