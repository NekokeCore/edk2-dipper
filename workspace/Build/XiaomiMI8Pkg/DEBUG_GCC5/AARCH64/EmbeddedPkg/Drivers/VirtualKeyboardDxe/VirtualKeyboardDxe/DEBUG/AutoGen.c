...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x88079b18, 0xb42b, 0x44aa, {0xa6, 0xf2, 0xb8, 0x39, 0x11, 0x07, 0x5e, 0x89}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtualKeyboardDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPlatformVirtualKeyboardProtocolGuid = { 0x0e3606d2, 0x1dc3, 0x4e6f, { 0xbe, 0x65, 0x39, 0x49, 0x82, 0xa2, 0x65, 0x47 }};
...
{
  return InitializeVirtualKeyboard (ImageHandle, SystemTable);
}
