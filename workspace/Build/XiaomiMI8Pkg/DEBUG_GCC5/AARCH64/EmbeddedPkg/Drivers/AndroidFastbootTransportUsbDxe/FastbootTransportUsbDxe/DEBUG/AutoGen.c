...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf6bec3fe, 0x88fb, 0x11e3, {0xae, 0x84, 0xe7, 0x3b, 0x77, 0x56, 0x1c, 0x35}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FastbootTransportUsbDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gUsbDeviceProtocolGuid = { 0x021bd2ca, 0x51d2, 0x11e3, {0x8e, 0x56, 0xb7, 0x54, 0x17, 0xc7,  0x0b, 0x44 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAndroidFastbootTransportProtocolGuid = { 0x74bd9fe0, 0x8902, 0x11e3, {0xb9, 0xd3, 0xf7, 0x22, 0x38, 0xfc, 0x9a, 0x31}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdAndroidFastbootUsbVendorId = _PCD_VALUE_PcdAndroidFastbootUsbVendorId;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdAndroidFastbootUsbProductId = _PCD_VALUE_PcdAndroidFastbootUsbProductId;
...
{
  return FastbootTransportUsbEntryPoint (ImageHandle, SystemTable);
}
