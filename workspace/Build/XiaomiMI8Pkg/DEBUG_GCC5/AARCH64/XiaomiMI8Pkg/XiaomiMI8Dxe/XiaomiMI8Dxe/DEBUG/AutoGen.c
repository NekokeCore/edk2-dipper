...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x422BB380, 0x0FFB, 0x41EC, {0xB8, 0x6E, 0xAE, 0x70, 0xF8, 0xA0, 0x2D, 0xA3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "XiaomiMI8Dxe";
...
{
  return XiaomiMI8EntryPoint (ImageHandle, SystemTable);
}
