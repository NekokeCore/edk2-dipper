...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xdcfd1e6d, 0x788d, 0x4ffc, {0x8e, 0x1b, 0xca, 0x2f, 0x75, 0x65, 0x1a, 0x92}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SimpleFbDxe";
...
{
  return SimpleFbDxeInitialize (ImageHandle, SystemTable);
}
